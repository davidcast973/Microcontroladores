...
# 2 "<built-in>" 2
# 1 "/opt/microchip/xc8/v2.00/pic/sources/c90/common/doprnt.c" 2
...
# 2 "/opt/microchip/xc8/v2.00/pic/sources/c90/common/doprnt.c" 2
# 1 "/opt/microchip/xc8/v2.00/pic/include/c90/ctype.h" 1 3
...
# 3 "/opt/microchip/xc8/v2.00/pic/sources/c90/common/doprnt.c" 2
# 1 "/opt/microchip/xc8/v2.00/pic/include/c90/stdlib.h" 1 3
...
# 65 "/opt/microchip/xc8/v2.00/pic/include/c90/stdlib.h" 3
...
# 100 "/opt/microchip/xc8/v2.00/pic/include/c90/stdlib.h" 2 3
...
# 4 "/opt/microchip/xc8/v2.00/pic/sources/c90/common/doprnt.c" 2
# 1 "/opt/microchip/xc8/v2.00/pic/include/c90/string.h" 1 3
# 14 "/opt/microchip/xc8/v2.00/pic/include/c90/string.h" 3
extern void * memcpy(void *, const void *, size_t);
extern void * memmove(void *, const void *, size_t);
extern void * memset(void *, int, size_t);
# 36 "/opt/microchip/xc8/v2.00/pic/include/c90/string.h" 3
...
# 5 "/opt/microchip/xc8/v2.00/pic/sources/c90/common/doprnt.c" 2


# 1 "/opt/microchip/xc8/v2.00/pic/include/c90/math.h" 1 3



# 1 "/opt/microchip/xc8/v2.00/pic/include/__unsupported.h" 1 3
# 5 "/opt/microchip/xc8/v2.00/pic/include/c90/math.h" 2 3
# 30 "/opt/microchip/xc8/v2.00/pic/include/c90/math.h" 3
...
# 8 "/opt/microchip/xc8/v2.00/pic/sources/c90/common/doprnt.c" 2
# 1 "/opt/microchip/xc8/v2.00/pic/include/c90/float.h" 1 3
# 9 "/opt/microchip/xc8/v2.00/pic/sources/c90/common/doprnt.c" 2
...
# 396 "/opt/microchip/xc8/v2.00/pic/sources/c90/common/doprnt.c"
...
# 416 "/opt/microchip/xc8/v2.00/pic/sources/c90/common/doprnt.c"
static double
...
# 463 "/opt/microchip/xc8/v2.00/pic/sources/c90/common/doprnt.c"
int
# 472 "/opt/microchip/xc8/v2.00/pic/sources/c90/common/doprnt.c"
printf(const char * f, ...)
{
 va_list ap;
# 507 "/opt/microchip/xc8/v2.00/pic/sources/c90/common/doprnt.c"
 char c;
 ...
 *ap = __va_start();
 ...
 while((c = *f++)) {
  ...
  flag = 0;
# 609 "/opt/microchip/xc8/v2.00/pic/sources/c90/common/doprnt.c"
  ...
  if(*f == '.') {
   flag |= 0x4000;
   f++;
# 639 "/opt/microchip/xc8/v2.00/pic/sources/c90/common/doprnt.c"
   {
    prec = 0;
    while(isdigit((unsigned)*f))
     prec = prec*10 + *f++ - '0';
  ...
  case 0:
   goto alldone;
# 681 "/opt/microchip/xc8/v2.00/pic/sources/c90/common/doprnt.c"
  case 'f':
   flag |= 0x400;
   break;
# 747 "/opt/microchip/xc8/v2.00/pic/sources/c90/common/doprnt.c"
  case 's':
   ...
   continue;
# 821 "/opt/microchip/xc8/v2.00/pic/sources/c90/common/doprnt.c"
  default:
# 832 "/opt/microchip/xc8/v2.00/pic/sources/c90/common/doprnt.c"
   continue;
# 841 "/opt/microchip/xc8/v2.00/pic/sources/c90/common/doprnt.c"
  }
...
# 1131 "/opt/microchip/xc8/v2.00/pic/sources/c90/common/doprnt.c"
     if(prec <= 12)
    ...
    if(flag & 0x03)
     width--;
# 1194 "/opt/microchip/xc8/v2.00/pic/sources/c90/common/doprnt.c"
    {
...
# 1309 "/opt/microchip/xc8/v2.00/pic/sources/c90/common/doprnt.c"
  if(prec == 0 && val == 0)
   prec++;
# 1358 "/opt/microchip/xc8/v2.00/pic/sources/c90/common/doprnt.c"
  if(c < prec)
   c = prec;
  else if(prec < c)
   prec = c;
...
# 1400 "/opt/microchip/xc8/v2.00/pic/sources/c90/common/doprnt.c"
  if(width > c)
   width -= c;
  else
   width = 0;
# 1441 "/opt/microchip/xc8/v2.00/pic/sources/c90/common/doprnt.c"
  {
   ...
   if(flag & 0x03)
    (putch('-') );
# 1488 "/opt/microchip/xc8/v2.00/pic/sources/c90/common/doprnt.c"
  }
# 1552 "/opt/microchip/xc8/v2.00/pic/sources/c90/common/doprnt.c"
 }
